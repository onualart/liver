...
Estimem el model i els contrastos.
...
genesHFDvsCPT <- top_HFDvsCPT["adj.P.Val"]<0.15
...
selectedIDs <- list(EntrezNCvsCPT, EntrezHFDvsCPT, EntrezNCvsHFD)
names(selectedIDs) <- c("NCvsCPT", "HFDvsCPT", "NCvsHFD")
